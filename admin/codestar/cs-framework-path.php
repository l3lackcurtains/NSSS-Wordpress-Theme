 ...
 *
 */
if( ! function_exists( 'tif_path_locate' ) ) {
  function tif_path_locate() {
    ...
    return apply_filters( 'tif_path_locate', array(
 ...
 *
 */
if ( ! function_exists( 'tif_option' ) ) {
  function tif_option( $option_name = '', $default = '' ) {

    $options = apply_filters( 'tif_option', get_option( CS_OPTION ), $option_name, $default );
 ...
 *
 */
if ( ! function_exists( 'tif_all_option' ) ) {
  function tif_all_option() {
 ...
 *
 */
if ( ! function_exists( 'tif_multilang_option' ) ) {
  function tif_multilang_option( $option_name = '', $default = '' ) {

    $value     = tif_option( $option_name, $default );
 ...
 *
 */
if ( ! function_exists( 'tif_customize_option' ) ) {
  function tif_customize_option( $option_name = '', $default = '' ) {

    $options = apply_filters( 'tif_customize_option', get_option( CS_CUSTOMIZE ), $option_name, $default );
 ...
 *
 */
if ( ! function_exists( 'tif_all_customize_option' ) ) {
  function tif_all_customize_option() {
 ...
 *
 */
load_textdomain( CS_TEXTDOMAIN, CS_DIR . '/languages/'. tif_locale() .'.mo' );
