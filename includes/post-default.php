<div class="post-default wrapper">
  <div class="row">
       <?php     
          if( have_posts() ):
    ...
    <div id="post-container" class="cell">
          ...
          <div class="post-image">
                  <?php echo the_responsive_featured_image(); ?>
          </div>
          <?php endif; ?>
          ...
          <!-- Post content -->
             ...
             echo substr(strip_tags($content), 0,300) . '<br/><br/><a class="readmore" href="'.get_the_permalink().'">Read More</a>';
             ?>
             </p>       
          <!-- end of post content-->
